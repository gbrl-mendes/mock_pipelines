...
-   **Define filtering function.** Create a wrapper function for filterAndTrim to handle forward and reverse reads, applying quality thresholds and removing PhiX.
...
-   **Execute filtering.** Run the filtering function in parallel across all samples and generate a summary table of read retention.
    ...
    all_filtered_out_fun <- furrr::future_pmap_dfr(
      list(primer_paired_files$Unique_File_name,
