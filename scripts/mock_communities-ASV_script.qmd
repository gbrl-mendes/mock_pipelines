    ...
    for (PRIMER_SET in primer_sets) {
      ...
      if (length(fnFs_in) > 0) {
        for (i in seq_along(fnFs_in)) {
          ...
          # Execute cutadapt
          system2(command = cutadapt, # Ensure 'cutadapt' path var is defined in Setup
